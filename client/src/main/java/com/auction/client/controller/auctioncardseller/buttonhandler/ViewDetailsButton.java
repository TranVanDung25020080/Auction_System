package com.auction.client.controller.auctioncardseller.buttonhandler;
...
public class ViewDetailsButton {
    public void handle(AuctionCardSellerController auctionCardSellerController){
        Auction auction=auctionCardSellerController.getAuction();
